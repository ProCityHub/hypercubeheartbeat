...
def build_deep_question_cycle(repo, active_goal):
    ...
    cycle = {
        ...
        "uncertainty": [
            {"type": "unknown", "statement": "Whether operational thinking will measurably improve decision quality over time."},
            {"type": "unknown", "statement": "Which baseline should be used first: manual selection, random candidate selection, or static planbook selection."},
            {"type": "assumption", "statement": "Dream, Bridge, and Lab should remain separate even when they point at the same question."}
        ],
        "power_request": {
